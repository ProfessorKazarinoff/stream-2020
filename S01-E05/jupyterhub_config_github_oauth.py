...
# Pull in the GitHub client ID and Secret from json file
with open('/etc/jupyterhub/github_oauth.json') as f:
    github_oauth = json.load(f)
GITHUB_CLIENT_ID = github_oauth['client_id'] 
GITHUB_CLIENT_SECRET = github_oauth['client_secret']

# Use GitHub Authentication
# GitHub OAuth Login
c.LocalGitHubOAuthenticator.oauth_callback_url = 'https://engr101lab.org/hub/oauth_callback'
...
c.Authenticator.whitelist = {'peter','gabby','ProfessorKazarinoff'}
