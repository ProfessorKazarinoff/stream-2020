...
## Users
with open('/etc/jupyterhub/users.json','r') as f:
    users_dict = json.load(f)
c.Authenticator.whitelist = set(users_dict['users'])
c.Authenticator.admin_users = set(users_dict['admin_users'])
...
# Custom Login Page
# First copy the templates from the JupyterHub env
# $ cd /opt/miniconda3/envs/jupyterhubenv/share/jupyterhub && ls
